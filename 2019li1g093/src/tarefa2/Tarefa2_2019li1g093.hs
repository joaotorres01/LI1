-- == Tarefa 2
-- |  Nesta tarefa o objetivo era definir uma função que permitisse ao Jogador efetuar Jogadas, ou seja, que o permitisse mudar de pista, inclinar-se quando está no Ar, acelerar, desacelerar
-- | e Disparar Cola. A nossa abordagem a este problema foi dividir a função principal em 7 casos diferentes e construir funções diferentes que pudessem suportar cada um desses casos.
-- | Deste modo, quando o jogador queria mudar de pista, criamos uma função que nos dizia qual o resultado desta mudança, sendo que ele poderia ir contra uma rampa, mudar efetivamente
-- | de pista ou passar para o Ar, se estivesse numa Rampa. Quando o Jogador estava no Ar e se queria inclinar nós dividimos em 2 casos diferentes, quando ele se queria inclinar para a
-- | esquerda (+15º) e quando ele se queria inclinar para a direita (-15º), sendo que aqui a única restrição era de que o Jogador não poderia ficar com uma inclinação superior a 90º nem 
-- | com uma inclinação inferior a 90º. Quando o Jogador queria disparar cola tivemos que criar uma função que verificava se estava numa posição válida para o efetuar, ou seja, se estava
-- | no chão, se tinha munições, se não estava morto e se não estava na primeira Peça. Por último, quando o jogador queria Acelerar ou Desacelerar fizemos 2 funções simples que apenas
-- | mudavam o estado do jogador de (Chão True) para (Chão False), e vice-versa.
...
testesT2 = [t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16,t17,t18,t19,t20,t21,t22,t23,t24,t25,t26,t27,t28,t29,t30,t31,t32,t32,t34,t35,t36,t37,t38,t39]
    where t1 = (0, Acelera, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 1 1 (Ar 1 0 0), Jogador 1 1 1 1 (Ar 1 0 0)]) --testa se o jogador consegue acelerar enquanto está no Ar
          ...
          t3 = (0, Acelera, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 0 1 (Morto 1.0), Jogador 1 1 1 1 (Chao False)])  --testa se o jogador consegue acelerar enquanto está Morto
          ...
          t6 = (0, Desacelera, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 0 1 (Morto 1.0), Jogador 1 1 1 1 (Chao False)]) --testa se o jogador consegue desacelerar enquanto está Morto
          ...
          t11 = (0, Dispara, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 0 1 (Morto 1.0), Jogador 1 1 1 1 (Chao False)]) -- testa se o jogador consegue dispara enquanto está Morto
          ...
          t15 = (0, Movimenta D, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 0 1 (Morto 1.0), Jogador 1 1 1 1 (Ar 1 0 0)]) --testa se o jogador consegue inclinar a mota para a direita, enquanto está Morto
          ...
          t19 = (0, Movimenta E, Estado [[Recta Terra 0, Recta Relva 0],[Recta Terra 0, Recta Relva 0]] [Jogador 0 1 0 1 (Morto 1.0), Jogador 1 1 1 1 (Ar 1 0 0)]) --testa se o jogador consegue inclinar a mota para a esquerda, enquanto está Morto
          ...
          t23 = (1, Movimenta C, Estado [[Recta Terra 0, Rampa Relva 0 2, Rampa Relva 2 0],[Recta Terra 0, Rampa Relva 0 2, Rampa Relva 2 0]] [Jogador 0 1.5 1 1 (Chao True), Jogador 1 1 0 1 (Morto 1.0)]) --testa se o jogador consegue movimentar a mota para a pista de cima, enquanto esta Morto
          ...
          t31 = (0, Movimenta B, Estado [[Recta Terra 0, Rampa Relva 0 2, Rampa Relva 2 0],[Recta Terra 0, Rampa Relva 0 2, Rampa Relva 2 0]] [Jogador 0 1.5 0 1 (Morto 1.0), Jogador 1 1 1 1 (Chao True)]) --testa se o jogador consegue movimentar a mota para a pista de baixo, enquanto esta Morto
...
jogada indice (Desacelera) (Estado mapa je) = (Estado mapa (atualizaIndiceLista indice (desacelarar (encontraIndiceLista indice je)) je))
...
desacelarar :: Jogador -- Jogador que quer desacelerar
             -> Jogador -- Jogador depois de desacelerar
desacelarar (Jogador a b c d e) = if (ifchao e)==True then (Jogador a b c d (Chao False)) else (Jogador a b c d e)
